...
#define LAYOUT_71( \
                   ...
                   K00_1, K01_1, K02_1, K03_1, K04_1, K05_1, K06_1, K07_1, K08_1, K09_1, K10_1, K11_1, K12_1, K13_1, K14_0, K15_0, \
                   K00_2, K01_2, K02_2, K03_2, K04_2, K05_2, K06_2, K07_2, K08_2, K09_2, K10_2, K11_2,        K13_2, K14_0, \
                   K00_3, K01_3, K02_3, K03_3, K04_3, K05_3, K06_3, K07_3, K08_3, K09_3, K10_3, K13_3, K14_3, \
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------------------------------------------------------------------|
     * |CAPS   |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|  Return| Pause| PgUp|
     * |--------------------------------------------------------------------------|
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|      Shift| Up| PgDn| 
     * |--------------------------------------------------------------------------|
     * |Ctrl|Gui |Alt |          Space          |Alt| Fn|  Ctrl|  Lef| Dow| Righ|
     * `--------------------------------------------------------------------------'
     */
    [_BL] = LAYOUT_71(
        SFT_ESC, KC_1,    KC_2,    KC_3,   KC_4,    KC_5,    KC_6,    KC_7,     KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,  KC_INS,  KC_HOME 
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                           KC_SPC,                     KC_LALT, MO(_FL), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
