...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_BL] = LAYOUT_60(
        MO(_FL), KC_1,    KC_2,    KC_3,   KC_4,    KC_5,    KC_6,    KC_7,     KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_RGUI,
     ...
     */
    [_FL] = LAYOUT_60(
        _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,   KC_F6,   KC_F7,    KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_ESC,
        KC_BSLS, KC_GRV, _______, _______, _______, _______, _______,  KC_HOME, KC_UP,   KC_END,  _______, KC_PGUP, _______, _______,
        KC_CAPS, KC_F13,  KC_F14,  KC_F15,  KC_F16,  _______, KC_PGUP, KC_LEFT, KC_DOWN, KC_RIGHT,KC_DOWN, KC_UP,            _______,
